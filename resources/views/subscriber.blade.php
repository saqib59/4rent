      ...
      <div class="col-md-6 col-md-offset-3">
        <div class="panel panel-default credit-card-box">
            ...
            <div class="panel-body">
                <div class="col-md-12">
                <form action="{{ route('subscribe.process') }}" method="POST" id="payment-form" data-parsley-validate>
                    @csrf
                    ...
                    <div class="form-group" id="product-group">
                        ...
                        <select name="plane" class="form-control" required data-parsley-class-handler="#product-group">
                            <option value="price_1JK1eCKWzDeJp8aSHQuDNwV6">Starter</option>
                            <option value="price_1JK5TGKWzDeJp8aSTaKGGEum">Experienced</option>
                            <option value="price_1JK1eCKWzDeJp8aSHQuDNwV6">Professional</option>
                            <option value="price_1JK1eCKWzDeJp8aSHQuDNwV6">High Level Investor</option>
                        </select>
