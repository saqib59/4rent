        ...
        <div class="card white-box p-0">
            <div class="card-heading pb-2">
                ...
                <div class="col-span-6 sm:col-span-6" style="border: 1px solid black;border-radius: 4px;text-align: center">
                    <label class="block font-medium text-lg text-gray-700" for="type"> {{$property->name}}</label>
                </div>
            </div>
                ...
                <div class="py-4" >
                    <div class="row pt-2 justify-center">
                        <div class="col-md-12 col-lg-4 col-sm-12 flex items-center">
                            <h3 class="text-lg font-medium text-gray-900">Name :  {{$property->name}}</h3>
                        </div>

                    </div>
                    <div class="row pt-2 justify-center">
                        <div class="col-md-12 col-lg-4 col-sm-12 flex items-center">
                            <h3 class="text-lg font-medium text-gray-900">SureName :</h3>
                        </div>
                                ...
                                <div class="px-4 py-5 bg-white sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6 sm:col-span-6">
                                            ...
                                            <textarea style="width: 100%" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" :value="value" @input="$emit('input', $event.target.value)" ref="input" name="description" spellcheck="false"></textarea>
                                        </div>
                                        <!-- Email -->
                                        <div class="col-span-6 sm:col-span-1">
                                            ...
                                            <input class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full" id="email" type="date" wire:model.defer="state.email">
                                        </div>
                                    </div>
                                </div>
